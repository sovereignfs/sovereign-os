...
- [Embedded OCI artifact proof report](embedded-oci-artifact-proof-report.md) - Deterministic ARM64 OCI embedding and Docker import passed; on-device import pending
